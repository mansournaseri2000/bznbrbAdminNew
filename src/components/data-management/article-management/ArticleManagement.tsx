...
const ArticleManagement = () => {
  ...
  const methods = useForm({
    defaultValues: {
      ...
      status: getParam('status') ? getParam('status') : '',
      base: getParam('base') ? getParam('base') : '',
      text: getParam('text') ? getParam('text') : '',
      related: getParam('related') ? getParam('related') : '',
      seo: getParam('seo') ? getParam('seo') : '',
      mainPic: getParam('mainPic') ? getParam('mainPic') : '',
  ...
  console.log(watch(),'dfsdfasdfsdfasdfsdf');
