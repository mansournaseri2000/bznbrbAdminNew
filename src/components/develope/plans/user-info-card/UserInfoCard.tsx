...
const UserInfoCard: React.FC<UserInfoCardProps> = (props: UserInfoCardProps) => {
  ...
  return (
    <Flex width={'100%'} maxWidth={'308px'} height={'min-content'} align={'center'} direction={'column'} p={'4'} gap={'4'} style={{ border: '1px solid #D4D4D4', borderRadius: 12 }}>
      <Box width={'120px'} height={'120px'} position={'relative'} style={{ borderRadius: '50%', border: '1px solid #D4D4D4' }}>
