...
const TicketInfo = (props: TicketInfoProps) => {
  const { startPointTime, endPointTime, startPointCity, endPointCity, startPointDay, endPointDay, startPointDate, endPointDate, PassengersList, ticketUrl, ticketQRCode } = props;
  return (
    <Box style={{ width: '100%', maxWidth: 640 }}>
      <Flex direction={'column'} p={'4'} gap={'2'} style={{ border: '1px solid #D4D4D4', borderRadius: '0px 0px 16px 16px' }}>
        <Flex width={'100%'} justify={'between'} align={'center'} pb={'4'} style={{ borderBottom: '1px solid #D4D4D4' }}>
      ...
      <Flex direction={'column'} p={'4'} gap={'4'} style={{ border: '1px solid #D4D4D4', borderRadius: 16 }}>
        ...
        <Box>
          {PassengersList.map((item, index) => (
            <Flex key={index} width={'100%'} justify={'between'} align={'center'} py={'4'} style={{ borderBottom: '1px solid #D4D4D4' }}>
      ...
      <Flex direction={'column'} align={'center'} p={'4'} gap={'3'} style={{ border: '1px solid #D4D4D4', borderRadius: '16px 16px 0px 0px' }}>
        <Flex width={'100%'} justify={'between'} align={'center'} py={'4'} px={'3'} style={{ border: '1px solid #D4D4D4', borderRadius: 12 }}>
