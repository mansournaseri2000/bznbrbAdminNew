...
// import { AllFilteredPlacesDetail, Pictrue } from '@/types/place/place-list';
...
//   const columns: ColumnDef<AllFilteredPlacesDetail>[] = [
//     {
//       accessorKey: 'index',
//       header: 'ردیف',
...
//   });
//   const newData = UseGetFilterTable(debouncedSearchCriteria, testData ? testData?.allFilteredPlaces : []);
//   const [placeItem, setPlaceItem] = useState<AllFilteredPlacesDetail>(newData[0]);
