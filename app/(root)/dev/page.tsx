...
import AutomationBanner from '@/components/develop/automation/automation-banner/AutomationBanner';
import GeographicInfo from '@/components/develop/automation/geographic-info/GeographicInfo';
import PersonnelDetail from '@/components/develop/automation/personnel-detail/PersonnelDetail';
import AutomationProfile from '@/components/develop/automation/profile/AutomationProfile';
import TeamDetailAutomation from '@/components/develop/automation/team-detail-automation/TeamDetailAutomation';
import TourLeaderInfo from '@/components/develop/automation/tour-leader-info/TourLeaderInfo';
import UserAutomation from '@/components/develop/automation/user-automation/UserAutomation';
import UserDetail from '@/components/develop/automation/user-detail/UserDetail';
...
import QuestionCard from '@/components/develop/support/question-card/QuestionCard';
...
import MemberDetail from '@/components/develop/teams-and-employers/member-detail/MemberDetail';
import TeamDetail from '@/components/develop/teams-and-employers/team-detail/TeamDetail';
import TourLeader from '@/components/develop/users/tour-leader/TourLeader';
import UserInfoCard from '@/components/develop/users/user-info-Card/UserInfoCard';
  ...
  return (
    <AppFlex width={'100%'} direction={'column'} gap={'5'} p={'5'} justify={'center'}>
      ...
      <AppFlex width={'100%'} direction={'column'} gap={'4'} align={'center'}>
        ...
        <UserInfoCard birthDate='1379/01/24' email='example@gmail.com' firstName='پویان' lastName='احمدی' mobile='091212345678' profileImg='' sex='مرد' userRole='تورلیدر' />
      </AppFlex>
      <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
        اطلاعات تورلیدری
      </AppHeading>
      ...
      <AppFlex width={'100%'} direction={'column'} gap={'4'} align={'center'}>
        ...
        <TeamDetail name='تیم مدیریت محتوا' managerEmail='long.example.123@gmail.com' personnelNumber={12} teamAccess={'دسترسی اصلی 1، دسترسی اصلی 2'} teamManager='حامد احمدی' />
        <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
          مشخصات پرسنل
        </AppHeading>
        <MemberDetail
      ...
      <AppFlex width={'100%'} direction={'column'} gap={'4'} align={'center'}>
        ...
        <BannerDetail bannerImage='' expirationDate='01 فروردین 1403' owner='شرکت پویان' title='پویان' header='بنر اول' />
        <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
      ...
      <AppFlex width={'100%'} direction={'column'} gap={'4'} align={'center'}>
        ...
        <UserAutomation date='چهارشنبه 10 فروردین 1401' operatedOn='میثم مطیعی' operatorName='حامد احمدی' status='در انتظار تایید' team='منابع انسانی' type='ثبت کاربر + تورلیدر' />
        <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
          افزوده شده
        </AppHeading>
        <PersonnelDetail
        ...
        <AutomationProfile type='افزودن' user='حامد احمدی' changeDate='چهارشنبه 10 فروردین 1401' profileImg='' status='بازگشت خورده' teamName='محتوا' />
        <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
          افزوده شده
        </AppHeading>
        <TeamDetailAutomation managerEmail='long.example.123@gmail.com' personnelNumber={12} teamAccess={'دسترسی اصلی 1، دسترسی اصلی 2'} teamManager='حامد احمدی' teamName='تیم مدیریت محتوا' />
        <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
          حذف شده
        </AppHeading>
        <TourLeaderInfo
        ...
        <UserDetail birthDate='1379/01/24' email='example@gmail.com' firstName='پویان' lastName='احمدی' mobile='091212345678' profileImg='' role='تورلیدر' sex='مرد' />
        <AppHeading color='red' style={{ width: '100%', borderBottom: '1px solid red', paddingBottom: 8 }}>
          افزوده شده
        </AppHeading>
        <GeographicInfo
        ...
        <AutomationBanner adOwner='شرکت پویان' expiryDate='01 فروردین 1403' header='بنر اول' imageUrl='' title='پویان' />
      </AppFlex>
      <AppHeading as='h1' color='blue' style={{ fontWeight: 'bold' }}>
        Support :
      </AppHeading>
