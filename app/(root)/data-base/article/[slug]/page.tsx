...
const seoItems = ['تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ', 'تگ'];
      ...
      <Flex direction={'column'} gap={'5'} p={'4'} style={{ border: '1px solid #D4D4D4', borderRadius: 8 }}>
        ...
        <Flex align={'center'} gap={'10px'}>
          {imgItem.map((item, index) => (
            <Flex width={'174px'} height={'224px'} direction={'column'} gap={'10px'} p={'12px'} key={index} style={{ border: '1px solid #D4D4D4', borderRadius: 8 }}>
              {item}
            </Flex>
          ))}
        </Flex>
